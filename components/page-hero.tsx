...
export function PageHero({
  ...
  return (
    <section className={`relative ${height} flex items-end justify-center bg-forest overflow-hidden`}>
      ...
      <div className="relative z-10 text-center px-6 pb-16 pt-32 max-w-4xl mx-auto">
        {label && (
